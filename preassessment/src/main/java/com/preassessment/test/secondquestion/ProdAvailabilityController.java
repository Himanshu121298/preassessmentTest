package com.preassessment.test.secondquestion;
...
import com.preassessment.test.firstquestion.ProductController;

@RestController
public class ProdAvailabilityController {
	
	private static final Logger logger = LoggerFactory.getLogger(ProdAvailabilityController.class);
